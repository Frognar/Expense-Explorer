...
{
  public static PurchaseIdsType New(
    params PurchaseIdType[] ids)
  {
    return new PurchaseIdsType(new ReadOnlyCollection<PurchaseIdType>(ids.ToList()));
  }

  public static bool Contains(
    this PurchaseIdsType ids,
    PurchaseIdType id)
    => ids.Ids.Contains(id);

  public static PurchaseIdsType Append(
    this PurchaseIdsType ids,
    PurchaseIdType id)
    => ids.Ids.Contains(id)
      ? ids
  ...
  public static PurchaseIdsType Without(
    this PurchaseIdsType ids,
    PurchaseIdType id)
